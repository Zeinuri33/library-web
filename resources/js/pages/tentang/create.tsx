    ...
    const submit = (e: React.FormEvent) => {
        ...
        post("/admin/tentang", {
            onSuccess: () => {
                ...
                toast(`Tentang ${data.nama} berhasil dibuat`, {
                    description: now,
                })
            },
            onError: () => {
                toast("Gagal menyimpan tentang", {
            ...
            <div className="p-6 space-y-6">
                <div className="flex items-center justify-between gap-4">
                    <Heading
                        ...
                        description="Buat halaman tentang baru."
                    />
                    <Link
                        href="/admin/tentang"
                        onClick={handleBack}
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => {
                                ...
                                if (!data.slug || data.slug === data.nama.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")) {
